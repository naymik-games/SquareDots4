class startGame extends Phaser.Scene {
  ...
  create() {
    ...
    */
    ...
    var title = this.add.text(game.config.width / 2, 100, 'SquareDots', { fontFamily: 'PixelFontWide', fontSize: '150px', color: '#c76210', align: 'left' }).setOrigin(.5)


    var startTime = this.add.bitmapText(game.config.width / 2 - 50, 275, 'topaz', 'Play Time', 50).setOrigin(0, .5).setTint(0x7AE5E3);
